...
FEATURE_CATALOG: tuple[dict[str, Any], ...] = (
    ...
    _feature(
        "company-workspace",
        "Company Workspace",
        "Organização operacional nativa por empresa e por agente, com WorkItems e fila do operador.",
        general_mode="direct",
        general_actions=("inspect", "list_items", "create", "assign", "update"),
        notes="Workspace organiza trabalho; ERP/core guarda fatos canônicos e memória guarda conhecimento.",
    ),
    _feature("colorglass-operations", "ColorGlass Operations", "Fonte de verdade operacional compartilhada entre Comercial, Orçamento, Compras, Logística e Financeiro.", general_mode="hybrid", general_actions=("inspect", "delegate_domain_action"), notes="O General inspeciona o estado canônico; cada agente especializado atualiza somente seu bloco por colorglass_ops_*."),
    ...
    _feature(
        "project-memory", "Memória Markdown por projeto",
        "Wiki .actis-memory persistente no workspace, com catálogo leve e carregamento seletivo de páginas.",
        general_mode="direct", general_actions=("bind", "catalog", "recall", "write", "promote"),
        notes="Observations são não verificadas por padrão e só viram decision/gotcha/workstream por promoção explícita.",
    ),
