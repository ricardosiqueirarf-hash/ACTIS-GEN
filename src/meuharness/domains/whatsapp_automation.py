...
_QUOTE_TERMS = re.compile(
    r"\b(or[cç]a|or[cç]ar|or[cç]amento|cotacao|cotação|porta|portas|giro|fixa|fixo|deslizante|correr|perfil|vidro|espelho|dobradi[cç]a)\b",
    re.I,
)
...
def process_inbound_once(agent_id: str, *, debounce_seconds: float = 5.0, contact_name: str | None = None) -> dict:
    ...
    prompt = (
        ...
        + confirmation_rule + fast_context + context_rule +
