...
def test_baileys_lid_only_outgoing_reuses_canonical_brazilian_contact():
    shadow.upsert_contact(
        "wa", "85988241620", external_id="+55 85 98824-1620", monitored=True
    )
    baileys._remember_peer(
        "wa", "85988241620", "261572232532189@lid", "558588241620", "direct"
    )

    outgoing_name, _, _ = baileys._contact_for_event(
        "wa",
        {
            "remote_jid": "261572232532189@lid",
            "phone": "",
            "peer_kind": "direct",
            "direction": "outgoing",
        },
    )
    incoming_name, _, _ = baileys._contact_for_event(
        "wa",
        {
            "remote_jid": "261572232532189@lid",
            "phone": "558588241620",
    ...
    assert outgoing_name == "85988241620"
    assert incoming_name == "85988241620"
    assert shadow.get_contact("wa", "85988241620") is not None
    assert shadow.get_contact("wa", "261572232532189@lid") is None
